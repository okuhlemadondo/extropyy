...
"[project]/lib/articles.js [ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$server$2d$only$2f$empty$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/server-only/empty.js [ssr] (ecmascript)");
...
function getAllPosts() {
    ...
    const allPosts = fileNames.map((fileName)=>{
        ...
        const slug = normalizedData.title ? generateSlug(normalizedData.title) : generateSlug(id);
        return {
            id: id,
            slug: slug,
            ...normalizedData,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$date$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/date.js [ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$articles$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/articles.js [ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mdx$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/mdx.js [ssr] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$MDXRenderer$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mdx$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__
]);
([__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$MDXRenderer$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mdx$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
...
async function getStaticPaths() {
    const posts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mdx$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["getAllPosts"])();
...
async function getStaticProps({ params }) {
    const post = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mdx$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["getPostBySlug"])(params.slug);
    if (!post) {
        return {
            notFound: true
        };
    }
    const allPosts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mdx$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["getAllPosts"])();
    // First try to get posts from the same category
    let sameCategoryPosts = allPosts.filter((p)=>p.slug !== post.slug && p.frontMatter.category === post.frontMatter.category);
    let relatedPosts = [];
    ...
    if (sameCategoryPosts.length >= 2) {
        ...
        const otherPosts = allPosts.filter((p)=>p.slug !== post.slug && p.frontMatter.category !== post.frontMatter.category)// Sort by date to get the most recent posts from other categories
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ed657c98._.js.map