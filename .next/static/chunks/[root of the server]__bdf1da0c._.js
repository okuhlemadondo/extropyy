(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__bdf1da0c._.js", {
...
"[project]/pages/articles/index.js [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function Articles({ posts, setIsLoading }) {
    ...
    const [filteredPosts, setFilteredPosts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(posts);
            ...
            setTimeout({
                "Articles.useEffect": ()=>{
                    ...
                    fadeElements.forEach({
                        "Articles.useEffect": (element)=>{
                            setTimeout({
                                "Articles.useEffect": ()=>{
                                    element.classList.add('visible');
                                }
                            }["Articles.useEffect"], 100);
                        }
                    }["Articles.useEffect"]);
                    // Add visible class to stagger-item elements
                    const staggerItems = document.querySelectorAll('.stagger-item');
                    staggerItems.forEach({
                        "Articles.useEffect": (item, index)=>{
                            setTimeout({
                                "Articles.useEffect": ()=>{
                                    item.style.opacity = '1';
                                    item.style.transform = 'translateY(0)';
                                }
                            }["Articles.useEffect"], index * 100);
                        }
                    }["Articles.useEffect"]);
                    // Debug information
...
_s(Articles, "0DgO9QgRztkDZK+xmarS96Q08ls=", false, function() {
    return [
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/pages/articles/index.js [client] (ecmascript)\" } [client] (ecmascript)": (function(__turbopack_context__) {
...
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/pages/articles/index.js [client] (ecmascript)");
    }
]);
...
"[project]/pages/articles/index.js (hmr-entry)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, m: module } = __turbopack_context__;
{
__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/pages/articles/index.js [client] (ecmascript)\" } [client] (ecmascript)");
}}),
}]);

//# sourceMappingURL=%5Broot%20of%20the%20server%5D__bdf1da0c._.js.map